...
def main():
    ...
    if not args.inference_only:
        ...
        # Validation features must be frozen at the split boundary.  Building
        # this index from train+validation leaked every validation edge into
        # its own count/recency features.
        val_extractor = TreeFeatureExtractor(train_part)
